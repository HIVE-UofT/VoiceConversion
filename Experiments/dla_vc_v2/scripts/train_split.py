...
LAMBDA_RECON = 5.0         # Feature MSE+cos. With residual output, this is mostly
                           # a regulariser that keeps the decoder output in WavLM
                           # space; conv_loss is the main supervision.
LAMBDA_RECON_PHASE2 = 5.0  # Same — kept symmetric since WARMUP_EPOCHS=0.
