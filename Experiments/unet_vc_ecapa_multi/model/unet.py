...
class ResUNet1D(nn.Module):
    ...
    def __init__(self, feat_dim=1024, hidden_dim=64, n_levels=2, dropout=0.4, spk_dim=192):
        super().__init__()
        ...
        # Speaker conditioning: project ECAPA embedding to bottleneck channel dim
        self.spk_proj = nn.Linear(spk_dim, ch)
    ...
    def forward(self, x, spk_emb=None):
        ...
        Args:
            ...
            spk_emb: (B, 192)      pre-surgery ECAPA embedding for patient identity
        """
        T_orig = x.shape[-1]
        ...
        # Inject patient identity: project (B, 192) -> (B, C, 1) and add to bottleneck
